...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='MTransformer',
                        help='model name, options: [MTransformer]')

    parser.add_argument('--data', type=str, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='traffic/traffic.csv', help='data file')
    ...
    parser.add_argument('--t_model', type=int, default=512, help='dimension of model')
    ...
    parser.add_argument('--down_sampling_method', type=str, default='down sampling method',
